...
const git = {
  ...
  getAuthor: (projectPath) => safeInvoke('cmd_git_get_author', { projectPath }),
  setAuthor: (projectPath, name, email, global) => safeInvoke('cmd_git_set_author', { projectPath, name, email, global }),
